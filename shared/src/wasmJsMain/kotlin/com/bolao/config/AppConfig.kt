...
actual object AppConfig {
    ...
    actual val SUPABASE_ANON_KEY: String
        get() = if (isDevEnvironment()) {
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFlY3Z0aWRsamt3eWRtb3Bic2dkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkyMTg5OTUsImV4cCI6MjA5NTAzOTIyM30.0k6bELat4llEYjcxuSP51K1F1UNb5rq4KQuzycOajbs"
        } else {
